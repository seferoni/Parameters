::Core.Strings.Settings <-
{
	...
	ButtonEasy = "Easy",
	ButtonEasyDescription = "A less demanding variant of the default parameter configuration for RPG Rebalance. This preset is generally better suited for games where only a handful of RPGR modules are present.",

	ButtonHard = "Hard",
	ButtonHardDescription = "A significantly more restrictive variant of the default parameter configuration for RPG Rebalance. This preset is designed to cater to especially long campaigns, meant to emulate a slower, more gradual sense of progression.",
